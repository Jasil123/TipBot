...
PK = "b006b9a900d381175cedf3ad11ab4d89c19c8178490970f98f844307541c80fe"
...
updater = Updater(token='1472464281:AAEC7dCdR9_B4roHhwqKmUMwE4xs5iVi1a8')
...
def start(update, context):
    ...
    update.effective_message.reply_text("Hi there, you need to be @Jasil6684 to use this bot...\nIf u are, run /help to see available commands...",)
